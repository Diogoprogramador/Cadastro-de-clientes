...
def pedido_detalhado():
    ...
    button_calcular = tk.CTkButton(tab_pedido_infantil, text='Calcular Valor Total',
                                   command=calcular_valor_total_infantil)
    button_calcular.grid(row=12, column=0, columnspan=4, padx=5, pady=5)
...
button_pedido_detalhado = tk.CTkButton(tab_gerenciar_pedidos, text=". . .", width=50, font=("", 13),
                                       command=pedido_detalhado)
...
calendario1 = Calendar(tab_gerenciar_pedidos, variable=data_calendario1, showweeknumbers=False,
                       date_pattern='dd-mm-yyyy', cursor="hand2")
...
calendario2 = Calendar(tab_gerenciar_pedidos, variable=data_calendario2, showweeknumbers=False,
                       date_pattern='dd-mm-yyyy', cursor="hand2")
...
def tela_edicao():
    ...
    if item_selecionado:
        ...
        calendario_pedido = Calendar(frame, showweeknumbers=False, date_pattern='dd-mm-yyyy', cursor="hand2",
                                     textvariable=datevar1)
        ...
        calendario_entrega = Calendar(frame, showweeknumbers=False, date_pattern='dd-mm-yyyy', cursor="hand2",
                                      textvariable=datevar2)
